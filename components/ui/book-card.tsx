...
export function BookCard({ book }: { book: any }) {
	return (
		<div className="flex flex-col w-fit h-fit">
			<a className="text-base md:text-lg font-medium hover:underline hover:cursor-pointer font-sans relative" href="">
				{book.sale ? <Discount price={book.price} sale={book.sale} /> : null}
...
const Discount = ({ price, sale }: { price: number; sale: number }) => {
	return (
		<span className="absolute top-0 left-0 py-1 px-2 bg-orange-600 rounded-br-xl rounded-tl-[calc(var(--radius)-5px)] text-base font-semibold font-sans text-white shadow">
